	...
	Plugin.prototype 					= 
	{
		init 							: function()
		{
			...
			function fc_attach_arrows()
			{
				...
				{
					// The HTML
					$arrow_nav_html				= '<div class="arrow-navigation left floating-logo"></div>';
					$arrow_nav_html				+= '<div class="arrow-navigation right floating-logo"></div>';
			...
			//hover停止轮播  离开继续轮播
			function fc_hover_ul(){
				$('.flicks').hover(function(){
					fc_auto_flick_stop();
				},function(){
					fc_auto_flick_reset();
				})
